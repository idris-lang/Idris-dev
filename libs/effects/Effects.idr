...
|||
||| This is useful for when no default environment for the given resource type.
|||
||| @env The default value for the resource type.
||| @prog The effectful program to run.
...
|||
||| A helper function useful for when the given context is 'pure' and their is no default environment.
|||
||| @env The default value for the environment.
||| @prog The effectful program to run.
