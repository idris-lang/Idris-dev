...
(\vC,\Delta,\vP,\vQ;\vn;\vQ')\gets\MO{Get}\\
\MO{Put}\;(\vC,\Delta,\vP,\vn;\vQ;\vQ')\\
}
}
...
\DM{
\MO{Unfocus}\;=\;\RW{do}\;\AR{
(\vC,\Delta,\vP,\vn;\vQ)\gets\MO{Get}\\
\MO{Put}\;(\vC,\Delta,\vP,\vQ;\vn)\\
}
}
...
arbitrary argument, we need not worry about implicit arguments or class
constraints. Instead, the function and argument are elaborated, and the results
applied. Since elaboration is type directed, however, there must be an
appropriate type for the function. 
