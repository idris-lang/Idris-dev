...
\todo[inline]{
\TT{} as a more general purpose intermediate language --- superset of System $\mathcal{F}$
for example. Primitive operators. A couple of example programs (derived from high
level examples in e.g. ML?).
}
