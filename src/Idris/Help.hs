...
help =
  [ (["<expr>"],            NoArg,           "Evaluate an expression"),
    ...
    ([":lto", ":loadto"],   NoArg,           "Load a file to the given line."),
    ([":log"],              NoArg,           "Set the logging level <level>."),
    ([":di", ":dbginfo"],   NoArg,           "Undocumented"),
    ([":let"],              ExprArg,         "Assign a local variable."),
    ...
    ([":hnf"],              NameArg,         "Undocumented"),
    ([":spec"],             NameArg,         "Undocumented"),
    ([":def"],              NameArg,         "Undocumented"),
    ([":patt"],             NameArg,         "Undocumented"),
    ([":inline"],           NameArg,         "Undocumented"),
    ([":errorhandlers"],    NoArg,           "Show the registered error handlers."),
    ([":universes"],        NoArg,           "Show the universes."),
...
extraHelp =
    ...
    , ([":makelemma", ":ml"],         NoArg, "Undocumented.")
    , ([":refine"],                   NoArg, "Undocumented.")
    ]
