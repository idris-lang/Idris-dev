...
elabPrims = do mapM_ (elabDecl' EAll recinfo)
    ...
    where elabPrim :: Prim -> Idris ()
          ...
          believeTy = Bind (sUN "a") (Pi (TType (UVar (-2))) (TType (UVar 0)))
                       (Bind (sUN "b") (Pi (TType (UVar (-2))) (TType (UVar 0)))
                         (Bind (sUN "x") (Pi (V 1) (TType (UVar 0))) (V 1)))
          elabBelieveMe
          ...
          synEqTy = Bind (sUN "a") (Pi (TType (UVar (-3))) (TType (UVar 0)))
                     (Bind (sUN "b") (Pi (TType (UVar (-3))) (TType (UVar 0)))
                      (Bind (sUN "x") (Pi (V 1) (TType (UVar 0)))
                       (Bind (sUN "y") (Pi (V 1) (TType (UVar 0)))
