...
elabDecl' what info (PRecord doc rsyn fc opts name ps pdocs fs fdocs cname cdoc csyn)
  | what /= ETypes
    = do iLOG $ "Elaborating record " ++ show name
         elabRecord info doc rsyn fc opts name ps pdocs fs fdocs cname cdoc csyn
{-
  | otherwise
