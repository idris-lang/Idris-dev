...
elabPrims = do mapM_ (elabDecl' EAll recinfo)
    ...
    where elabPrim :: Prim -> Idris ()
          ...
          believeTy = Bind (sUN "a") (Pi False (TType (UVar (-2))) (TType (UVar (-1))))
                       (Bind (sUN "b") (Pi False (TType (UVar (-2))) (TType (UVar (-1))))
                         (Bind (sUN "x") (Pi False (V 1) (TType (UVar (-1)))) (V 1)))
          elabBelieveMe
          ...
          synEqTy = Bind (sUN "a") (Pi False (TType (UVar (-3))) (TType (UVar (-2))))
                     (Bind (sUN "b") (Pi False (TType (UVar (-3))) (TType (UVar (-2))))
                      (Bind (sUN "x") (Pi False (V 1) (TType (UVar (-2))))
                       (Bind (sUN "y") (Pi False (V 1) (TType (UVar (-2))))
