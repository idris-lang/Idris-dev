...
primitives =
  ...
  Prim (UN "prim__addW32") (ty [W32Type, W32Type] W32Type) 2 (w32Bin (+))
    (2, LW32Plus) total,
   Prim (UN "prim__subW32") (ty [W32Type, W32Type] W32Type) 2 (w32Bin (-))
     (2, LW32Minus) total,
   Prim (UN "prim__mulW32") (ty [W32Type, W32Type] W32Type) 2 (w32Bin (*))
     (2, LW32Times) total,
   ...
   Prim (UN "prim__intToWord16") (ty [IType] W16Type) 1 intToWord16
    (1, LW16) total,
   Prim (UN "prim__intToWord32") (ty [IType] W32Type) 1 intToWord32
    (1, LW32) total,
...
intToWord32 [VConstant (I x)] = Just $ VConstant (W32 $ fromIntegral x)
intToWord32 _ = Nothing
