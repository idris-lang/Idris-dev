...
data IBCFile = IBCFile { ver :: Word8,
                         ...
                         ibc_coercions :: [Name],
                         ibc_linenames :: [(FilePath, Int, Name, Int)]
                       }
   deriving Show
{-! 
...
ibc i (IBCLineName fp l n w) f 
     = return f { ibc_linenames = (fp,l,n, w) : ibc_linenames f }
...
pLineNames :: [(FilePath, Int, Name, Int)] -> Idris ()
pLineNames ls = mapM_ (\ (f, i, n, w) -> addInternalName f i n w) ls
