...
collect (PInstance doc argDocs f s cs acc opts n nfc ps pextra t en ds : ds')
    = PInstance doc argDocs f s cs acc opts n nfc ps pextra t en (collect ds) : collect ds'
